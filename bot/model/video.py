...
class Video:
    ...
    def __init__(self):
        key_words = ["Tulips-flowers", "Orchids-flowers", "Lilies-flowers", "Lotus-flower", "Dahlia-flower",
                     "Apple-blossom", "lily-flower", "Snapdragons-flowers", "Aster-flower", "Violet-flower",
                     "Waterfall", "Ghost-Orchid", "Titan-Arum", "Pitcher-Plant", "Black-Bat-Flower",
                     "Corpse-Lily", "Kokia-Cookei", "Jade-Vine", "Venus-Flytrap", "Rafflesia-Arnoldii",
                     "Chocolate-Cosmos", "Gladioli-flower", "CherryTree", "PineTree", "Mountain", "River", "Sun"]
